...
const { TS_NODES, defineVisitor: tsDefineVisitor } = require('./indent-ts')
...
const ES_PROPOSAL_NODES = [
  'ClassProperty'
]
const KNOWN_NODES = new Set([...ES_NODES, ...VUE_NODES, ...ES_PROPOSAL_NODES, ...TS_NODES])
const LT_CHAR = /[\r\n\u2028\u2029]/
const LINES = /[^\r\n\u2028\u2029]+(?:$|\r\n|[\r\n\u2028\u2029])/g
